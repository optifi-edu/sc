...
contract MockBlendFinance {
    IERC20 public immutable mockEDU;
    ...
    constructor(
        ...
        require(_mockEDU != address(0), "Invalid token address");
        mockEDU = IERC20(_mockEDU);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockEDU.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockEDU.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockEDU.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockEDU.transfer(owner, mockEDU.balanceOf(address(this)));

        emit WithdrawAll(owner, mockEDU.balanceOf(address(this)));
    }
